...
class BBP_Bayes_Net_LR(BaseNet):
    ...
    def __init__(self, lr=1e-3, channels_in=9, side_in=128, cuda=True, classes=6, batch_size=128, Nbatches=0,
                 nhid=2400, prior_sig=0.1):
    ...
    def create_net(self):
        ...
        self.model = bayes_linear_LR_2L(input_dim=self.channels_in * self.side_in, output_dim=self.classes,

...
if __name__ == '__main__':
    ...
    # Paths
    base_dir = './results/bbb_lr_results'
        ...
        for lr in lrs:
            for momentum in momentums:
                for n_sample in n_samples:
                    ...
                    Hps = 'Sigs_' + str(prior_sig) + '_Lr_' + str(lr) + '_Momentum_' + str(momentum) + '_Nsample_' + str(n_sample)
                    ...
                    for split in range(int(n_splits)):
                        ...
                        # net dims
                        cprint('c', '\nNetwork:')
                        net = BBP_Bayes_Net_LR_BH_hetero(lr=lr, input_dim=inputs, output_dim=outputs, cuda=use_cuda,

        ...
        for lr in lrs:
            for momentum in momentums:
                for n_sample in n_samples:
                    ...
                    print('Grid search step: Prior_sigs: ' + str(prior_sig) + \
                    ' Lr: ' + str(lr) + ' Momentum: ' + str(momentum) + ' N_sample: ' + str(n_sample))

                    results_dir = './bbb_lr_results/Sigs_' + str(prior_sig) + \
                    ...
                    for split in range(int(n_splits)):
                        ...
                        results_val = './bbb_lr_results/results_val_split_' + str(split) + '.txt'
                        results_test = './bbb_lr_results/results_test_split_' + str(split) + '.txt'
                        # net dims
                        cprint('c', '\nNetwork:')
                        net = BBP_Bayes_Net_LR_BH(lr=lr, input_dim=inputs, output_dim=outputs, cuda=use_cuda,

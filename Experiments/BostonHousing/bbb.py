...
if __name__ == '__main__':
            ...
            for lr in lrs:
                for momentum in momentums:
                    for n_sample in n_samples:
                        ...
                        print('Grid search step: Prior: ' + str(prior) + ' Prior_sigs: ' + str(prior_sig) + \
                        ' Lr: ' + str(lr) + ' Momentum: ' + str(momentum) + ' N_sample: ' + str(n_sample))

                        results_dir = './bbb_results/Prior_' + str(prior) + '_Sigs_' + str(prior_sig) + \
    ...
    for i in range(len(results_order_rmse)):
        with open('./bbb_results/results_rmse.txt', 'a') as f:
    ...
    for i in range(len(results_order_picp)):
        with open('./bbb_results/results_picp.txt', 'a') as f:
